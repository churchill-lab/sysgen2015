...
We will first create a matrix of covarites to use in the mapping model. DOQTL requires a covariate called "sex" becuase it is used to map on the X chromosome. We will also use diet as a covariate. There are three important points to remember with covarites.
